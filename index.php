...
<?php include_once("includes/header.php"); ?>
                ...
                <div class="rev_slider fullscreenbanner" data-version="5.1.4" id="rev_slider_280_1" style="display:none;">
                    <ul>
                        ...
                        <li data-description="" data-easein="Power2.easeInOut" data-easeout="default" data-index="rs-898" data-masterspeed="1500" data-param1="" data-param10="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-rotate="0" data-saveperformance="off" data-slotamount="default" data-title="Slide" data-transition="fade">
                            <!-- MAIN IMAGE -->
                            <img alt="img" class="rev-slidebg" data-bgparallax="12" data-bgposition="top center" data-duration="30000" data-ease="Linear.easeNone" data-no-retina="" src="images/revo-slider/index.jpg">
                            ...
                            data-voffset="['-105','-105','-90','-85']">IMAGINATION</div> 
                            ...
                            data-hoffset="['0','0','0','0']" 
                            data-y="['center','center','center','center']" 
                            data-voffset="['-20','-20','-20','-20']">WILL TAKE YOU
                            </div>
                            ...
                            data-hoffset="['0','0','0','0']" 
                            data-y="['center','center','center','center']" 
                            data-voffset="['70','70','55','50']">EVERYWHERE
                            </div>
                        </li>
                    </ul>
					...
					<div class="container fes1-cont">
						<div class="row">
							...
							<div class="col-md-4 fes1-img-cont wow fadeInUp mb-20">
								<img src="images/feature1-img2.png" alt="img" >
							</div>
            ...
            <ul class="port-grid display-hover-on-mobile clearfix masonry" id="items-grid">
              ...
              <li role="button" class="port-item mix">
                ...
                <div class="port-overlay-cont">
                    ...
                    <div class="port-title-cont">
                      <h3><a href="#">EYES OF THE CAR</a></h3>
        ...
        <div class="port-view-more-cont">
          <a class="port-view-more" href="#">VIEW MORE PROJECTS</a>
        </div>
        ...
        <div id="blog-link" class="page-section pt-110-b-30-cont">
          <div class="container">
            ...
            <div class="mb-50">
              <h2 class="section-title pr-0">LATEST <span class="bold">NEWS</span><a href="#" class="section-more right">OUR BLOG</a>
                  </h2>
            </div>
          ...
          <div class="container">
            <div class="relative" >
              <div id="mc_embed_signup" class="nl-form-container clearfix">
                <form action="mail.php" method="post" name="mc-embedded-subscribe-form" class="newsletterform validate">   <!-- EDIT THIS ACTION URL (add "post-json?u" instead of "post?u" and appended "&amp;c=?" to the end of this URL) -->
                  <input type="email" value="" name="email" class="email nl-email-input" placeholder="Enter your email" required>
                  <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                  <div style="position: absolute; left: -5000px;"><input type="text" name="b_ba37086d08bdc9f56f3592af0_e38247f7cc" tabindex="-1" value=""></div>
          
                  <input type="submit" value="SUBSCRIBE" name="subscribe" class="button medium gray">
                </form>
